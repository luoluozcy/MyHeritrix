$(function(){
    ...
    function loadFile () {
        ...
        if (!isIE() || ($.browser.msie && $.browser.version === "10.0")) {
            var loginJs = createElement('script','text/javascript','scripts/login.js?511260');
            var passportJs = createElement('script','text/javascript','scripts/passport.js?511260');
            var loginCss = createElement('link','text/css','styles/login.css?v=511260');

            head.appendChild(loginJs);
            head.appendChild(passportJs);
            head.appendChild(loginCss);
        }
        var yloginJs = createElement('script','text/javascript','scripts/ylogin.js?511260');
