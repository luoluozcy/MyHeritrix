...
function moveMouse(e) {
   //boxMove=true;
	...
	if (boxMove&&CBE) {
		...
		oDv.style.left=((fixposx)||(fixposx==0))?fixposx:bodyScrollLet+mouseX+ox+lockX+ 20 +"px";
		oDv.style.top=((fixposy)||(fixposy==0))?fixposy:bodyScrollTop+mouseY+oy+lockY -20 + "px";		
