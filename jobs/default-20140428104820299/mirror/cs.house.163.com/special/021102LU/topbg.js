...
function showTopCrown(){
	...
	bodyObj.style.background = "url(http://img.bh111.com/flash/cs/zdjahc_bg.jpg) no-repeat top center";
	...
	adObj.innerHTML =insertMyCrown(960,'80','http://img.bh111.com/flash/cs/zdjahc960x80.gif','http://xf.house.163.com/cs/0P1G.html');
    //adObj.innerHTML =insertMyCrown(960,'80','http://img.bh111.com/flash/cs/fjsjgy960x80.swf','http://xf.house.163.com/cs/0P1G.html');
...
function closeTopCrown(){
	...
	if(''!='')	{
		document.getElementById("topcrownplayer").innerHTML=insertMyCrown(0,0,'','http://xf.house.163.com/cs/0P1G.html');
