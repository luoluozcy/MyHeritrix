...
function showTopCrown(){
	...
	bodyObj.style.background = "url(http://file.ws.126.net/house/chengdu/images/srjx-tbj.jpg) no-repeat top center";
	...
	adObj.innerHTML =insertMyCrown(960,'80','http://img.bh111.com/flash/srjx960--80.swf','http://xa.house.163.com/special/0215sp/srjx.html');
...
function closeTopCrown(){
	...
	if(''!='')	{
		document.getElementById("topcrownplayer").innerHTML=insertMyCrown(0,0,'','http://xa.house.163.com/special/0215sp/srjx.html');
