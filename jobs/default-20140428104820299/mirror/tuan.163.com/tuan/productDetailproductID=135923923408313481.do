...
<header class="top_head" id="top_head">
  <div class="top_header">
    <p class="f_right"><a href="#">设为主页</a>|<a href="#">加为收藏</a></p>
  </div>
  ...
  <nav class="main_nav">
    <ul class="nav_list">
      <li><a href="/tuan/index.do" >今日团购</a></li>
      <li><a href="/tuan/map.do"  >团购地图</a></li>
      <li><a href="/tz/nav.do" >团购导航</a></li>
      <li><a href="/tuan/personalcenter.do" >个人中心</a></li>
      <li><a href="/tuan/pointReward.do" >积分兑换</a></li>
    </ul>
  </nav>
</header>
<section class="content">
<section class="err_box">
  <div>
      <span class="tips_icon err"></span>
	  <h4>抱歉,您查询的团购信息现在无法打开！</h4>
	   您可以试试如下操作<br>
...
<footer class="main_footer">
  <nav class="footer_nav"><a href="/tz/nav.do">团购导航</a><span>|</span><a href="/tuan/about.html?v=20130123">关于我们</a><span>|</span><a href="http://survey2.163.com/html/newversion6/paper.html?v=20130123">意见反馈</a><span>|</span><a href="/tuan/api.html?v=20130123">开放API</a><span>|</span><a href="/tuan/help.html?v=20130123">帮助</a></nav>
