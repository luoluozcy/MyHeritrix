...
<section class="err_box">
  <div>
      <span class="tips_icon warn"></span>
      <p>抱歉，出错啦！</p>
	  <h4>网易团长提示您：</h4>
	  <p>您可以试试如下操作</p>
...
<footer class="main_footer">
  <nav class="footer_nav"><a href="/tz/nav.do">团购导航</a><span>|</span><a href="/tuan/about.html">关于我们</a><span>|</span><a href="http://survey2.163.com/html/newversion6/paper.html">意见反馈</a><span>|</span><a href="/tuan/api.html">开放API</a><span>|</span><a href="/tuan/help.html">帮助</a></nav>
